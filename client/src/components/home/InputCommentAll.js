...
import { createCommentAll } from "../../redux/actions/commentAction";
import Icons from "../Icons";

const InputCommentAll = ({ children, post, onReply, setOnReply }) => {
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(createCommentAll({ post, newComment, auth, socket }));
    if (setOnReply) {
      return setOnReply(false);
    }
  };
